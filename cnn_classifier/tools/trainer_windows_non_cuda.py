...
from read_data_non_cuda import ChestXrayDataSet, ChestXrayDataSetTest
...
class Trainer:
    ...
    def train(self, TRAIN_IMAGE_LIST, VAL_IMAGE_LIST, NUM_EPOCHS=10, LR=0.001, BATCH_SIZE=16,
